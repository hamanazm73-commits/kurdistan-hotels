...
import { effectivePrice, pickLang, mediaSrc, type Hotel } from "@/lib/types";
...
export function MapClient({ initialHotels }: { initialHotels?: Hotel[] }) {
  const { t, tCity, lang } = useI18n();
  // seeded from the server, so pins are ready as soon as Leaflet loads
