...
const ckb: Dict = {
  ...
  admin_autotranslate: "وەرگێڕانی خۆکار بۆ هەموو زمانەکان",
  admin_translating: "وەرگێڕان...",
  admin_translate_empty: "سەرەتا ناو یان وەسف بنووسە",
  admin_translate_done: "وەرگێڕدرا — تکایە بیپشکنە",
  admin_translate_failed: "وەرگێڕان سەرکەوتوو نەبوو",
...
const en: Dict = {
  ...
  admin_autotranslate: "Auto-translate to all languages",
  admin_translating: "Translating...",
  admin_translate_empty: "Enter a name or description first",
  admin_translate_done: "Translated — please review",
...
const ar: Dict = {
  ...
  admin_autotranslate: "ترجمة تلقائية لكل اللغات",
  admin_translating: "جاري الترجمة...",
  admin_translate_empty: "أدخل الاسم أو الوصف أولاً",
  admin_translate_done: "تمت الترجمة — يرجى المراجعة",
  admin_translate_failed: "فشلت الترجمة",
...
const kmr: Dict = {
  ...
  admin_autotranslate: "Werger bo hemû zimanan",
  admin_translating: "Werger...",
  admin_translate_empty: "Pêşî nav an danasînê binivîse",
  admin_translate_done: "Hate wergerandin — ji kerema xwe kontrol bike",
  admin_translate_failed: "Werger bi ser neket",
