...
const ckb: Dict = {
  ...
  admin_closed: "بەکاتی داخراوە",
  admin_closed_hint: "هۆتێلەکە لە سایتەکە دەمێنێتەوە بەڵام حیجز وەرناگرێت. تەلەفۆن و واتساپ کاردەکەن.",
...
const en: Dict = {
  ...
  admin_closed: "Temporarily closed",
  admin_closed_hint: "The hotel stays listed but takes no bookings. Phone and WhatsApp keep working.",
...
const ar: Dict = {
  ...
  admin_closed: "مغلق مؤقتاً",
  admin_closed_hint: "يبقى الفندق معروضاً لكن بدون حجوزات. الهاتف والواتساب يعملان.",
...
const kmr: Dict = {
  ...
  admin_closed: "Demkî girtî",
  admin_closed_hint: "Otêl di lîsteyê de dimîne lê rezervasyon nagire. Telefon û WhatsApp dixebitin.",
