...
const ckb: Dict = {
  ...
  book_guests: "گەورەسالان",
  book_males: "پیاو",
  book_females: "ژن",
  book_party: "کێ دەمێنێتەوە؟",
  book_party_total: "{n} کەس",
  book_child_n: "منداڵی {n}",
  book_years: "{n} ساڵ",
  book_need_guest: "لانیکەم یەک کەس دیاری بکە",
  book_children: "منداڵان",
  book_child_ages: "تەمەنی منداڵەکان",
  book_child_age_ph: "تەمەن",
  book_child_under1: "خوار ١ ساڵ",
  book_gender: "ڕەگەز",
  book_male: "نێر",
  book_female: "مێ",
  ...
  stat_when: "کەی؟",
  stat_when_hint: "ئەگەر پەیامێکی نەناسراوت پێگەیشت، کاتەکە لێرە بپشکنە — ئەگەر یەک خولەک پێشتر بێت، لە سایتەکەوە هاتووە.",
  stat_kind_whatsapp: "واتساپی کردەوە",
  stat_kind_call: "تەلەفۆنی کردەوە",
  stat_kind_map: "نەخشەی کردەوە",
  stat_kind_contact: "پەیوەندی",
  ...
  rv_ask_title: "چۆن بوو؟ هەڵسەنگاندنێک بنووسە",
  rv_ask_cta: "کلیک بکە",
  bk_ask_review: "داوای هەڵسەنگاندن بکە",
  rv_reply_from: "وەڵامی هۆتێل",
  rvr_hint: "دەتوانیت وەڵامی هەڵسەنگاندنەکان بدەیتەوە. وەڵامەکەت بۆ هەمووان دەردەکەوێت.",
  rvr_your_reply: "وەڵامی تۆ",
  rvr_placeholder: "بە ڕێزەوە وەڵام بدەوە — خوێنەر وەڵامەکەت دەبینێت.",
  rvr_save: "وەڵامەکە بنێرە",
  rvr_remove: "وەڵامەکە لابە",
  rvr_saved: "پاشەکەوت کرا",
  rvr_save_failed: "پاشەکەوت نەکرا",
  rvr_load_failed: "نەهێنرا",
  bk_review_wa: "سڵاو {name}، سوپاس بۆ مانەوەت. ئەگەر کاتت هەبوو، هەڵسەنگاندنێکمان بنووسە — زۆر یارمەتیمان دەدات:",
...
const en: Dict = {
  ...
  book_males: "Men",
  book_females: "Women",
  book_party: "Who's staying?",
  book_party_total: "{n} people",
  book_child_n: "Child {n}",
  book_years: "{n} yrs",
  book_need_guest: "Add at least one guest",
  book_children: "Children",
  book_child_ages: "Children's ages",
  book_child_age_ph: "Age",
  book_child_under1: "Under 1",
  book_gender: "Gender",
  book_male: "Male",
  book_female: "Female",
  ...
  stat_when: "When?",
  stat_when_hint: "Got a message you can't place? Check the times here — if one is a minute earlier, they came from the site.",
  stat_kind_whatsapp: "opened WhatsApp",
  stat_kind_call: "opened the dialer",
  stat_kind_map: "opened the map",
  stat_kind_contact: "got in touch",
  ...
  rv_ask_title: "How was it? Leave a review",
  rv_ask_cta: "Tap here",
  bk_ask_review: "Ask for a review",
  rv_reply_from: "Reply from the hotel",
  rvr_hint: "You can answer reviews about your hotel. Your reply is shown publicly.",
  rvr_your_reply: "Your reply",
  rvr_placeholder: "Answer courteously — readers see your reply.",
  rvr_save: "Post reply",
  rvr_remove: "Remove reply",
  rvr_saved: "Saved",
  rvr_save_failed: "Could not save",
  rvr_load_failed: "Could not load",
  bk_review_wa: "Hello {name}, thank you for staying with us. If you have a moment, a review would help us a lot:",
...
const ar: Dict = {
  ...
  book_guests: "البالغون",
  book_males: "رجال",
  book_females: "نساء",
  book_party: "من سيقيم؟",
  book_party_total: "{n} أشخاص",
  book_child_n: "طفل {n}",
  book_years: "{n} سنة",
  book_need_guest: "أضف شخصًا واحدًا على الأقل",
  book_children: "الأطفال",
  book_child_ages: "أعمار الأطفال",
  book_child_age_ph: "العمر",
  book_child_under1: "أقل من سنة",
  book_gender: "الجنس",
  book_male: "ذكر",
  book_female: "أنثى",
  ...
  stat_reviews: "تقييم",
  stat_when: "متى؟",
  stat_when_hint: "وصلتك رسالة لا تعرف مصدرها؟ راجع الأوقات هنا — إن كان أحدها قبل دقيقة، فهم من الموقع.",
  stat_kind_whatsapp: "فتح واتساب",
  stat_kind_call: "فتح الهاتف",
  stat_kind_map: "فتح الخريطة",
  stat_kind_contact: "تواصل",
  ...
  rv_ask_title: "كيف كانت الإقامة؟ اكتب تقييماً",
  rv_ask_cta: "اضغط هنا",
  bk_ask_review: "اطلب تقييماً",
  rv_reply_from: "رد الفندق",
  rvr_hint: "يمكنك الرد على التقييمات. ردك يظهر للجميع.",
  rvr_your_reply: "ردك",
  rvr_placeholder: "رُد بلطف — القراء يرون ردك.",
  rvr_save: "إرسال الرد",
  rvr_remove: "حذف الرد",
  rvr_saved: "تم الحفظ",
  rvr_save_failed: "تعذر الحفظ",
  rvr_load_failed: "تعذر التحميل",
  bk_review_wa: "مرحباً {name}، شكراً لإقامتك معنا. إذا كان لديك وقت، تقييمك سيساعدنا كثيراً:",
...
const kmr: Dict = {
  ...
  book_males: "Mêr",
  book_females: "Jin",
  book_party: "Kî dimîne?",
  book_party_total: "{n} kes",
  book_child_n: "Zarok {n}",
  book_years: "{n} sal",
  book_need_guest: "Bi kêmî yek kesî zêde bike",
  book_children: "Zarok",
  book_child_ages: "Temenê zarokan",
  book_child_age_ph: "Temen",
  book_child_under1: "Di bin 1 salî",
  book_gender: "Zayend",
  book_male: "Nêr",
  book_female: "Mê",
  ...
  stat_when: "Kengî?",
  stat_when_hint: "Peyamek hat û tu nizanî ji ku ye? Li deman binêre — ger yek deqe berê be, ji malperê hatine.",
  stat_kind_whatsapp: "WhatsApp vekir",
  stat_kind_call: "telefon vekir",
  stat_kind_map: "nexşe vekir",
  stat_kind_contact: "têkilî danî",
  ...
  rv_ask_title: "Çawa bû? Nirxandinek binivîse",
  rv_ask_cta: "Li vir bitikîne",
  bk_ask_review: "Nirxandin bixwaze",
  rv_reply_from: "Bersiva otêlê",
  rvr_hint: "Tu dikarî bersiva nirxandinan bidî. Bersiva te ji her kesî re xuya dibe.",
  rvr_your_reply: "Bersiva te",
  rvr_placeholder: "Bi rêz bersiv bide — xwîner bersiva te dibîne.",
  rvr_save: "Bersivê bişîne",
  rvr_remove: "Bersivê rake",
  rvr_saved: "Hat tomarkirin",
  rvr_save_failed: "Nehat tomarkirin",
  rvr_load_failed: "Nehat barkirin",
  bk_review_wa: "Silav {name}, spas ji bo mayîna te. Ger wextê te hebe, nirxandinek pir alîkariya me dike:",
