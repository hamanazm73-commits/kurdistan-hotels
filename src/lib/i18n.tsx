...
const ckb: Dict = {
  ...
  farm_bedrooms: "ژوور",
  farm_bathrooms: "حەمام",
  farm_area: "ڕووبەر (م²)",
  farm_guests: "کەس",
  farm_units: "{n} بەردەستە",
  detail_farm: "وردەکاری مەزرەعە",
  detail_farm_sub: "ئەم مەزرەعەیە بە تەواوەتی بە کرێ دەگیردرێت.",
...
const en: Dict = {
  ...
  farm_bathrooms: "Bathrooms",
  farm_area: "Area (m²)",
  farm_guests: "Guests",
  farm_units: "{n} available",
  detail_farm: "Farm details",
  detail_farm_sub: "This farm is rented as a whole.",
...
const ar: Dict = {
  ...
  farm_bedrooms: "غرف",
  farm_bathrooms: "حمامات",
  farm_area: "المساحة (م²)",
  farm_guests: "أشخاص",
  farm_units: "{n} متوفرة",
  detail_farm: "تفاصيل المزرعة",
  detail_farm_sub: "تُؤجَّر هذه المزرعة بالكامل.",
...
const kmr: Dict = {
  ...
  farm_bedrooms: "Jûr",
  farm_bathrooms: "Serşok",
  farm_area: "Rûerd (m²)",
  farm_guests: "Mêvan",
  farm_units: "{n} amade",
  detail_farm: "Kîtekîtên zeviyê",
  detail_farm_sub: "Ev zevî bi tevahî tê kirêkirin.",
